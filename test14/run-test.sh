...
# ENERGIES CORRESPOND TO LAMBDA VALUES OF 0.0, 0.7 AND 1.0. SMOOTH CUTOFFS ARE USED WITHOUT EWALD SUMMATION.
...
echo "PHF IN WATERBOX WITH CENTRAL CHARGES; PERT ENERGY CALCULATION (STANDARD CHARMM VS DEV CODE)"
echo
echo $LOG1
echo "lambda 0.0"
