...
#SBATCH --job-name=dcm-pcpt
#SBATCH --nodes=1
#SBATCH --ntasks=8 
#SBATCH --partition=long

# THIS TEST LOOKS AT A SOLVATED TRIPEPTIDE IN A WATERBOX WITH PATCHED RESIDUES AT EACH END OF THE
# TRIPEPTIDE CHAIN. ELECTROSTATICS ARE MODELLED USING SMOOTH CUT-OFFS, DCM CHARGES ARE USED TO CREATE
# TIP4P WATER MOLECULES AND TO ADD MULTIPOLES TO CERTAIN PEPTIDE ATOMS. MADE-UP POLARIZABILITIES WERE
# ADDED TO CERTAIN PEPTIDE AND WATER ATOMS TO TEST SIMULATION STABILITY. CPT DYNAMICS ARE RUN
