...
# HEATING DURING A SHORT DYNAMICS RUN. SMOOTH "FSHIFTED" CUTOFFS ARE USED WITHOUT EWALD SUMMATION
...
echo
echo "TFSHIFT WITH 10-CHG MODEL: DEV DCM CODE VS REFERENCE DCM CODE"
